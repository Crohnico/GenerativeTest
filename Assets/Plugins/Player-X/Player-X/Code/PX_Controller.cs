...
namespace PlayerX
{
    public class PX_Controller : MonoBehaviour
    {
        ...
        void Direction()
        {
            ...
            if (dependencies.playerCamera.followCamera && dependencies.playerCamera.cameraRotation)
            {
        ...
        void Rotate()
        {
            if (enableRotate && dependencies.playerCamera.followCamera)
            {
                ...
                if (!dependencies.playerCamera.cameraRotation)
                {
                    //... Spin player
